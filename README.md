...
A relational database is a type of database that stores and provides access to data points that are related to one another. SQL (Structured Query Language) is the language used to interact with: search, view, and manipulate (update and delete) the data in the database.

- [ ] Why do tables need a `primary key`?
Tables need a primary key so they have a way to uniquely identify a given row or record in a table to ensure that there're no duplicates.
